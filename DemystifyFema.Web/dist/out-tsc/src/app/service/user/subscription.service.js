...
var SubscriptionUserService = /** @class */ (function () {
    ...
    SubscriptionUserService.prototype.getPaytmOrderStatus = function (req) {
        if (req) {
            var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
            var data = this._httpClient.post("http://localhost:51159/common/api/paytmorderstatus", req, { headers: headers });
            return data;
        }
    };
